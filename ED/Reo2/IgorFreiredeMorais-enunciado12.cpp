/* 
    ...
    Solução de: Igor Freire de Morais 
*/
...
clinica::clinica(clinica& copia) {
    quantidadeDePacientes = copia.quantidadeDePacientes;
    capacidadeMaxima = copia.capacidadeMaxima;
    
    listaDePacientes = new paciente[capacidadeMaxima];
    
    copy(copia.listaDePacientes, copia.listaDePacientes+quantidadeDePacientes,listaDePacientes);
...
void clinica::redimensionarCapacidade() {
	paciente *novalistaPaciente = new paciente[capacidadeMaxima];
	copy(listaDePacientes, listaDePacientes+quantidadeDePacientes, novalistaPaciente);
	delete [] listaDePacientes;
	capacidadeMaxima =  ceil(capacidadeMaxima * 1.5);
	
	listaDePacientes = new paciente[capacidadeMaxima];
	copy(novalistaPaciente, novalistaPaciente+quantidadeDePacientes, listaDePacientes);
	delete [] novalistaPaciente;
